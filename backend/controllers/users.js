...
//DELETE HTTP method to /Users. Here, we pass in a param which is the object username.
router.delete('/:username', (req, res, next) => {
    let username = req.params.username;
    //Call the model method deleteUserByUsername
    user.deleteUserByUsername(username, (err, currUser) => {
        if (err) {
